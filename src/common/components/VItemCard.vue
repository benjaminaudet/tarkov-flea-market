  ...
  <n-space vertical v-else>
    <n-card bg="black">
      <template #header >
        ...
        <div class="h-10 text-center">{{ item.name }}</div>
      </template>
      <n-tabs
        type="line"
        size="small"
      ...
      >
        <n-tab-pane name="Price Stats">
          <n-space>
            <div>
              <n-space>
                <n-tag :bordered="false"> Prix Moyen 24h</n-tag>
            ...
            <div>
              <n-space>
                <n-tag :bordered="false"> Variation Prix Moyen vs 48h</n-tag>
                <n-tag :bordered="false" type="success" class="bold">
          ...
          <VButton
            ><a :href="item.wikiLink" target="_blank">Page Wiki</a></VButton
          >
        </n-tab-pane>
        <n-tab-pane name="General Stats"> ROCKLIFE </n-tab-pane>
      </n-tabs>
    </n-card>
  </n-space>
</template>
