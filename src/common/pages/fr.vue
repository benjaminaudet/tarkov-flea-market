...
const { result, loading, error } = useGetItemsQuery('fr')
        ...
        <div>
                ...
                <div>
                    <n-space vertical>
                        ...
                        <n-grid x-gap="12" y-gap="12" cols="2">
                            <n-gi>
                                <n-select filterable placeholder="Choisir un filtre" :options="sortOptions"
                                    class="w-[100%]" default-value="avg24hPrice" @update:value="toggleSort">
                                    <template #arrow>
                                        <transition name="slide-left">
                                            <IconAscendingSort v-if="sortDirectionAsc"
                                                :style="`color: ${colors.teal[400]}`" />
            ...
            <div>
                <n-space vertical>
                    ...
                    <n-grid v-if="dataToUse" ref="" v-scroll="onScroll" class="overflow-y-scroll h-[100vh] pr-2"
                        x-gap="12" y-gap="12" cols="5 xs:1 s:1 m:1 l:2 xl:3 2xl:4 3xl:4" responsive="screen">
