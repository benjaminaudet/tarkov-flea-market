    ...
    <div>
      ...
      <div>
        <n-space vertical>
          ...
          <n-cascader v-model:value="selectedCategory" placeholder="Category" clearable :options="filterButtons"
            :cascade="true" check-strategy="child" :show-path="true" :filterable="true"
            :clear-filter-after-select="true" @update:value="filterByCategory" />
          <n-back-top :listen-to="target" :bottom="220" :visibility-height="10" :style="{
            transition: 'all .3s cubic-bezier(.4, 0, .2, 1)',
          }" />
          <n-grid v-if="dataToUse" id="items" ref="" v-scroll="onScroll" class="overflow-y-scroll h-[100vh] pr-2"
